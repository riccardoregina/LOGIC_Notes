...
\begin{proof}
  Per dimostrare la prima direzione, ovvero che \(\Gamma\models\phi\) implica l'esistenza di un sottoinsieme finito \(\Gamma_0\subseteq\Gamma\) tale che \(\Gamma_0\models\phi\), iniziamo notando che dal teorema di correttezza si ha
  \[\Gamma \models \phi \implies \Gamma \vdash \phi\]
  ...
  \[\Gamma_0\models\phi\overset{\text{corr}}{\implies}\Gamma_0\vdash\phi\overset{\text{mon}}{\implies}\Gamma\vdash\phi\overset{\text{comp}}{\implies}\Gamma\models\phi\]
\end{proof}
