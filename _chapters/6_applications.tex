...
\begin{definition}{Proprietà}
  Sia \(L\) un linguaggio di \(\FOL\) e sia \(\mathcal{M}\) la classe delle strutture con \(M \in \mathcal{M}\) se \(M = \langle D,\Interp\rangle\) per \(L\). Una \keyword{proprietà} \(P\) è un qualsiasi un sottoinsieme di \(\mathcal{M}\).
\end{definition}
...
\begin{definition}{Espressibilità}
  Sia \(L\) un linguaggio di \(\FOL\) e sia \(\mathcal{M}\) la classe delle strutture con \(M \in \mathcal{M}\) se \(M = \langle D,\Interp\rangle\) per \(L\). Una proprietà \(P\) è \keyword{esprimibile} in \(L\) se esiste una formula \(\phi \in \FOL\) tale che \(P=\den{\phi}=\set{M \in \mathcal{M} \mid M \models \phi}\)
\end{definition}
