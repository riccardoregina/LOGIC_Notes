...
\begin{definition}{Ragionamento valido (informalmente)}
  Un ragionamento è detto \keyword{valido} se, in ogni \qi{situazione} in cui tutte le premesse sono vere, anche la conclusione è vera.
\end{definition}
...
La validità è strettamente connessa a un altro concetto fondamentale: la consistenza (o coerenza) di un insieme di enunciati.
...
D'altra parte, l'insieme \qi{piove}, \qi{c'è vento} \textbf{non} è inconsistente: è ragionevole pensare che le due affermazioni possano essere contemporaneamente vere, anche se ci si potrebbe trovare in una situazione in cui non c'è né pioggia né vento.
...
\begin{example}{Inconsistenza di un insieme di enunciati}
...
In particolare, vediamo come il ragionamento per assurdo si applica a un caso concreto.

\begin{example}[label=ex:logical_consequence]{Verifica della conseguenza logica}
  Dati gli enunciati \(\Gamma\):
  \begin{enumerate}
    \item Se Carlo è italiano e Giovanni non è spagnolo, allora Rachele è tedesca\label{ex_item:logical_consequence_1}
